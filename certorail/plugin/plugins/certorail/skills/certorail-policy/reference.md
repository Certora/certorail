...
```
certorail run      (PROGRAM | -c SOURCE) [--root DIR] [--policy FILE] [--no-jail] [-- ARG ...]
certorail check    (PROGRAM | -c SOURCE) [--root DIR] [--policy FILE]
certorail-run [--check] (-c SOURCE | FILE) [-- ARG ...]
certorail describe [--root DIR] [--policy FILE]
certorail explore  [--root DIR] [--policy FILE]
